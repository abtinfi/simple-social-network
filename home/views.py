...
class PostDetailView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            new_commetn = form.save(commit=False)
            new_commetn.user = request.user
            new_commetn.post = self.post_instance
            new_commetn.save()
...
class PostDeleteView(LoginRequiredMixin, View):
    def get(self, request, post_id):
        ...
        if post.user.id == request.user.id:
            post.delete()
            messages.success(request, "post deleted succsessfuly", "success")
        else:
...
class PostUpdateView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            new_post.save()
            messages.success(request, "your edited successfuly", "success")
...
class PostCreateView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            new_post.save()
            messages.success(request, "you create new post successfuly", "success")
...
class PostAddReplyView(LoginRequiredMixin, View):
    ...
    def post(self, request, post_id, comment_id):
        ...
        if form.is_valid():
            ...
            reply.is_reply = True
            reply.save()
            messages.success(request, "your comment saved", "success")
        return redirect("home:post_detail", post.id, post.slug)
